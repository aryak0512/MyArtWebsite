...
<title>Aryak's Website-HIGH SCHOOL</title>
</head>
<body>
    ...
    <!-- <div class="container">
      ...
      <img src="logo.png" height="40px" width="65px">&nbsp;&nbsp;
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item" >
            <a class="nav-link" href="UserServlet?id=memes">My Meme Collection
            ...
            <div class="card h-100">
              ...
              <div class="card-footer">
                <small class="text-muted">
                  <a href="AdminServlet?id=likeM&pid=${i.getId() }" ><button onclick="myFunc()" class="btn btn-primary" >LIKE</button></a> &nbsp;&nbsp;
